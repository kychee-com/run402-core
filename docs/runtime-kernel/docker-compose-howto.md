...
Run402 Core is a single-node self-hosting runtime. This path is meant to prove the supported runtime slice is runnable outside Run402 Cloud; it is not a production HA deployment.
