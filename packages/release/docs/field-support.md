...
| `routes[].pricing.receipt` | Publicly interpreted | `"on_fulfillment"` declares portable seller intent. Receipt signing and managed signer lifecycle remain adapter behavior. |
